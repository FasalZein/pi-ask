...
const PI_ASK_CONFIG_PROMPT = `When the user asks to configure, customize, debug, or explain @fasalzein/pi-ask settings or keymaps, first read ${CONFIGURATION_DOC_PATH} and follow it as the source of truth before editing config files.`;
